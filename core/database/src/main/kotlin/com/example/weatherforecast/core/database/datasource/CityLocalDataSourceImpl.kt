...
internal class CityLocalDataSourceImpl @Inject constructor(
    ...
    override suspend fun upsertCity(city: City): Result<Unit, AppError> = try {
    ...
    override suspend fun deleteCity(cityId: String): Result<Unit, AppError> = try {
